...
public class LambdaUtil {
    ...
    public static Supplier<String> helloSupplier() {
        //todo
        Supplier<String> randomValue = () -> "hello";
        return randomValue;}
    ...
    public static Predicate<String> isEmptyPredicate() {
        //todo
            Predicate<String> lesserthan = i -> (i.length()==0);
            return (Predicate<String>) lesserthan;
    }
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        //todo
        BiFunction<String, Integer, String> Multiplier = (a, b) -> a.repeat(b);
        return  Multiplier;
    }
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        //todo
        Function<BigDecimal, String> dollar = bigDecimal -> "$"+bigDecimal;
        return dollar;
    }
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        //todo
        Predicate<String> isLength = n -> 4 <= n.length() & 8>n.length();
        return isLength;
    }
